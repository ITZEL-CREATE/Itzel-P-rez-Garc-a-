...
📲Proyecto: Lista de hipótesis que pueden ayudar a aumentar los ingresos en una tienda online.
💻https://cnt-14771677-932c-4353-8498-fc6e6daed77f.containerhub.tripleten-services.com/notebooks/notebook-Copy1.ipynb

📲Proyecto: EMPRESA DE PRODUCTOS ALIMENTICIOS PROYECTO:Investigación el comportamiento del usuario para la aplicación de la empresa
...
Poca antigüedad (lifetime corto) → mayor probabilidad de cancelar.
Usuarios sin contrato largo (mensuales) → más propensos a irse.
Gastos adicionales (servicios premium) → correlacionan con lealtad.
Perfiles de usuario según clústeres:
Clúster con usuarios frecuentes y contratos largos → leales.
Clúster de usuarios nuevos con visitas bajas → alto riesgo.
Recomendaciones:
Incentivar contratos largos con promociones.
Ofrecer programas de fidelización para aumentar el uso de servicios adicionales.
Envío de alertas personalizadas a clientes con baja frecuencia de visitas.
Monitorear nuevos clientes durante los primeros meses, y ofrecer seguimiento personalizado.
